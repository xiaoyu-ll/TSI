...
//int pl[15];//每个顶点的标签是lq[i]的概率,*分母
int pdin[15];//每个顶点有入度vq[i].indegree的概率,*分母
int pdout[15];//每个顶点有出度vq[i].outdegree的概率,*分母
//int pf[15];//每个顶点的匹配概率，小的优先,*分母
int pf[15]={0,48,24,84,82,22,33};
